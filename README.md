...
- 3 lives para o desenvolvimento do projeto, instruindo acerca de cada um dos elementos e propriedades aplicados
- O projeto foi personalizado e incrementado por mim, indo além da base ministrada nas aulas
